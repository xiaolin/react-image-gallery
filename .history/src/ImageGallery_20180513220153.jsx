...

        {
          this._canNavigate() ?
            [
              this.props.showNav &&
                <span key='navigation'>
                  {this.props.renderLeftNav(slideLeft, isRTL ? !this._canSlideNext() : !this._canSlidePrevious())}
                  {this.props.renderRightNav(slideRight, isRTL ? !this._canSlidePrevious() : !this._canSlideNext())}
                </span>,
