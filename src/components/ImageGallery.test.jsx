...
describe("&lt;ImageGallery /&gt;", () => {
  ...
  describe("custom renderers", () => {
    ...
    it("uses custom renderFullscreenButton", () => {
      const customFullscreen = (onClick, isFullscreen) => (
  ...
  describe("fullscreen", () => {
    ...
    it("handles fullscreenchange event", () => {
      ...
      document.fullscreenElement = document.querySelector(".image-gallery");
    ...
    it("handles mozfullscreenchange event", () => {
      ...
      document.mozFullScreenElement = document.querySelector(".image-gallery");
    ...
    it("handles MSFullscreenChange event", () => {
      ...
      document.msFullscreenElement = document.querySelector(".image-gallery");
