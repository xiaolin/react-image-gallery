      ...
      <section className="app">
        ...
        <div className="app-sandbox">
          <div className="app-sandbox-content">
            ...
            <p>
              If you plan to use multiple `ImageGallery`s on one site, you
              should start using `arrowKeysInFullscreenOnly` to prevent
              unexpected behaviour, or all galleries will slide when the arrow
              keys are pressed. Just use the arrow keys on this site and see
              what happens. Only the first gallery reacts in non-fullscreen. The
              second one only listens to keyDown events in fullscreen.
            </p>
          </div>
        </div>
